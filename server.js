...
// НОВАЯ СИСТЕМА НАСТРОЕНИЙ - ОСОЗНАННОЕ ОБЩЕНИЕ
const moods = {
    'need_heard': { 
        name: 'Мне нужно просто быть услышанным', 
        emoji: '🗣️', 
        color: '#667eea',
        description: 'Не дави, не советуй — просто слушай.'
    },
    'light_talk': { 
        name: 'Хочу отвлечься и поговорить о чём-то лёгком', 
        emoji: '🌤️', 
        color: '#FFD93D',
        description: 'Давай поговорим о хорошем.'
    },
    'quiet_presence': { 
        name: 'Ищу тихое присутствие — можно и без слов', 
        emoji: '☁️', 
        color: '#95A5A6',
        description: 'Просто знать, что кто-то рядом.'
    },
    'ready_to_support': { 
        name: 'Готов(а) поддержать другого человека', 
        emoji: '🤝', 
        color: '#48bb78',
        description: 'Хочу быть тем, кто слушает.'
    },
    'deep_conversation': { 
        name: 'Хочу глубокий разговор о чём-то важном', 
        emoji: '💭', 
        color: '#9B59B6',
        description: 'Готов(а) говорить честно.'
    }
};
...
const idealMatches = {
    ...
    'light_talk': ['light_talk', 'quiet_presence'],
...
💫 Осознанное общение | 🎭 5 типов диалогов
...
🎯 НАСТРОЕНИЯ:
🗣️  Мне нужно просто быть услышанным
🌤️  Хочу отвлечься и поговорить о лёгком  
☁️  Ищу тихое присутствие
🤝  Готов(а) поддержать другого
💭  Хочу глубокий разговор
    `);
});